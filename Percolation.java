...
/**
* @return true if given site is open else false
*/
...
/**
* @return true if the given site is connected with first row else false
*/
...
/**
* return true if the first row of given system is unioned with its last row else false
*/
